export default `
  ...
  <section class="mb-section-gap fade-in text-justify" id="history">
    <h2 class="font-display text-headline-md md:text-headline-lg mb-8 text-primary border-l-4 border-accent-gold pl-6">Jejak Prasejarah dan Kerajaan Bali Kuno</h2>
    <p class="font-body text-body-md md:text-body-lg mb-paragraph-gap">
  ...
  <section class="mb-section-gap fade-in text-justify" id="architecture">
    <h2 class="font-display text-headline-md md:text-headline-lg mb-8 text-primary border-l-4 border-accent-gold pl-6">Nekara "Bulan Pejeng" dan Konsep Tri Mandala</h2>
    <p class="font-body text-body-md md:text-body-lg mb-paragraph-gap">
